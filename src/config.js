...
export const CONFIG = {
  ...
  post2: {
    ...
    captionExpanded:
      "서울에 있을 때도 저희는 늘 바다를 꿈꿨고, 여름을 기다렸습니다. 지나온 사진마다 함께 술잔을 들고 웃고 있는 걸 보면 참 저희답다는 생각이 듭니다. 결국 좋아하는 바다를 따라 제주로 오게 되었고, 이곳에서 저희만의 매일을 만들어가고 있습니다.<br><br>어느 계절이든 제주가 문득 그리워질 때, 망설이지 말고 제주의 용철과 유진을 찾아주세요. 언제나 반갑게 맞아드릴게요.",
    photos: [
