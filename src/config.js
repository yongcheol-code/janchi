...
export const CONFIG = {
  ...
  party: {
    ...
    mapDesc: "언제 오셔도 좋고 언제 가셔도 좋습니다. 2호선 성수역 3번 출구 도보 5분, 주차는 근처 공영주차장을 이용해 주세요.",
    schedule: [
      { time: "16:00", title: "오픈", desc: "오시고 싶은 시간에 오셔서, 가고 싶을 때 가시면 됩니다", accent: false },
      { time: "20:00", title: "신랑신부 인사 & 럭키드로우", desc: "딱 이 시간에만 진행합니다. 자리에 계신 분들께 선물을 드려요", accent: true },
